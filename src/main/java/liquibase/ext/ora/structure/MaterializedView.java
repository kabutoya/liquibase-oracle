...
public class MaterializedView extends AbstractDatabaseObject {
     ...
     * Public or Private
     */
    public MaterializedView setType(String type) {
     ...
     * DB-Link名
     */
    public MaterializedView setDBLinkName(String name) {
     ...
     * 接続先ID/PWD
     */
    public MaterializedView setUser(String name) {
    ...
    public MaterializedView setPassword(String name) {
     ...
     * 認証ID/PWD
     */
    public MaterializedView setAuthUser(String name) {
    ...
    public MaterializedView setAuthPassword(String name) {
     ...
     * 接続サービス名
     */
    public MaterializedView setUsing(String name) {
