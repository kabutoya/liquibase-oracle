...
import liquibase.ext.ora.output.changelog.ChangedMViewChangeGenerator;
...
public class ChangedMViewest extends BaseTestCase {
    private ChangedMViewChangeGenerator generator;
    ...
    public void setUp() throws Exception {
        generator = new ChangedMViewChangeGenerator();
     }
